            ...
            <nav class="flex h-full w-full flex-col p-2" aria-label="Chat history">
                <div class="mb-1 flex flex-row gap-2">
                    <a onclick="backToHello()" class="flex px-3 min-h-[44px] py-1 items-center gap-3 transition-colors duration-200 dark:text-white cursor-pointer text-sm rounded-md border dark:border-white/20 hover:bg-gray-500/10 h-11 bg-white dark:bg-transparent flex-grow overflow-hidden">
                        <svg t="1697600043545" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4283" width="20" height="20">
                    ...
                    <span class="" data-state="closed">
                        <a class="flex h-11 w-11 items-center justify-center border rounded-md dark:border-white/20 hover:bg-gray-500/10 bg-white dark:bg-transparent">
                            <img src="images/network_test_logo.jpg" alt="Logo" class="w-full h-full object-contain">
                        </a>
                    </span>
                </div>
                <div
