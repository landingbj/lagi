              ...
              <div role="presentation" class="flex h-full">
                ...
                <div id="hello-page" class="flex-1 h-full">
                  <div id="mytab" class="hidden">
                    ...
                    <div class="agent-list-container tab" class="w-full" id="agent-list-container">
                      ...
                      <div>
                        <a onclick="backToChat()">
                          <svg class="back-button" xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                            viewBox="0 0 100 100" style="cursor: pointer;">
                            ...
                            <polyline points="45,35 35,50 45,65" stroke="#000" stroke-width="10" fill="none"
                              class="arrow" />
                          </svg>
                        </a>
                      </div>
                    ...
                    <div class="paid-agent-list-container w-full tab" id="user-upload-file-container">
                      </br>
                      ...
                      <div id="upload-file-list">
                        ...
                        <div class="navbar"
                          style="display: flex; justify-content: center; background-color: #023f63; padding: 10px 0;">
                          ...
                          <a href="#" id="link1"
                            style="color: white; text-decoration: none; padding: 5px 10px; margin: 0 15px; border-radius: 5px; transition: background-color 0.3s;">
                            我的语料
                          </a>
                          <a href="#" id="link2"
                            style="color: white; text-decoration: none; padding: 5px 10px; margin: 0 15px; border-radius: 5px; transition: background-color 0.3s;">
                        ...
                        <div id="chat-settings">
                          <div
                            style="padding: 20px; background-color: #fff; border-radius: 8px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1); width: 100%;  height: auto; box-sizing: border-box;">
                            <!-- LLM 温度 -->
                            ...
                            <p style="font-size: 1.1em; line-height: 1.5; color: #555;">
                              数字越高越有创意。对于某些模型，如果设置得太高，可能会导致响应不一致。</p>
                            </br>
                            <p style="font-size: 1.1em; line-height: 1.5; color: #555;">模型不同，此 LLM温度 的有效值范围也不同。</p>
                            <hr style="margin: 30px 0; border: 1px solid #eee;" />
                            <div style="margin-top: 20px; display: flex; align-items: center;">
                              <label for="textBlockSize"
                                style="font-size: 1.1em; margin-right: 10px; width: 180px;">温度(temperature)：</label>
                              <input type="number" id="wendu_type" value="0.8"
                              ...
                              <button onclick="submitSettings('wendu_type')"
                                style="background-color: #023f63; color: white; border: none; padding: 8px 16px; font-size: 1.1em; border-radius: 4px; cursor: pointer; transition: background-color 0.3s;">提交</button>
                              &nbsp;&nbsp;
                              <button onclick="resetSlice('wendu_type')"
                                style="background-color: #023f63; color: white; border: none; padding: 8px 16px; font-size: 1.1em; border-radius: 4px; cursor: pointer; transition: background-color 0.3s;">重置</button>
                            </div>
                            <!-- 文本切片设置 -->
                            </br>
                            ...
                            <p style="font-size: 1.1em; line-height: 1.5; color: #555;">
                              温馨提示：修改此设置前，请确保您熟悉文本分割的逻辑及其可能带来的影响。若您对此不太确定，建议保持默认设置或咨询专业人员。</p>

                            <hr style="margin: 30px 0; border: 1px solid #eee;" />

                            <div style="margin-top: 20px; display: flex; align-items: center;">
                              <label for="textBlockSize"
                                style="font-size: 1.1em; margin-right: 10px; width: 180px;">文本类-文本块大小：</label>
                              <input type="number" id="wenben_type" value="512"
                                style="width: 80px; padding: 8px; font-size: 1.1em; margin-right: 10px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;" />
                              <button onclick="submitSettings('wenben_type')"
                                style="background-color: #023f63; color: white; border: none; padding: 8px 16px; font-size: 1.1em; border-radius: 4px; cursor: pointer; transition: background-color 0.3s;">提交</button>
                              &nbsp;&nbsp;
                              <button onclick="resetSlice('wenben_type')"
                                style="background-color: #023f63; color: white; border: none; padding: 8px 16px; font-size: 1.1em; border-radius: 4px; cursor: pointer; transition: background-color 0.3s;">重置</button>
                            </div>

                            <div style="margin-top: 20px; display: flex; align-items: center;">
                              <label for="textBlockOverlap"
                                style="font-size: 1.1em; margin-right: 10px; width: 180px;">表格类-文本块大小：</label>
                              <input type="number" id="biaoge_type" value="512"
                                style="width: 80px; padding: 8px; font-size: 1.1em; margin-right: 10px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;" />
                              <button onclick="submitSettings('biaoge_type')"
                                style="background-color: #023f63; color: white; border: none; padding: 8px 16px; font-size: 1.1em; border-radius: 4px; cursor: pointer; transition: background-color 0.3s;">提交</button>
                              &nbsp;&nbsp;
                              <button onclick="resetSlice('biaoge_type')"
                                style="background-color: #023f63; color: white; border: none; padding: 8px 16px; font-size: 1.1em; border-radius: 4px; cursor: pointer; transition: background-color 0.3s;">重置</button>
                            </div>

                            <div style="margin-top: 20px; display: flex; align-items: center;">
                              <label for="textBlockOverlap"
                                style="font-size: 1.1em; margin-right: 10px; width: 180px;">图文类-文本块大小：</label>
                              <input type="number" id="tuwen_type" value="512"
                                style="width: 80px; padding: 8px; font-size: 1.1em; margin-right: 10px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;" />
                              <button onclick="submitSettings('tuwen_type')"
                                style="background-color: #023f63; color: white; border: none; padding: 8px 16px; font-size: 1.1em; border-radius: 4px; cursor: pointer; transition: background-color 0.3s;">提交</button>
                              &nbsp;&nbsp;
                              <button onclick="resetSlice('tuwen_type')"
                                style="background-color: #023f63; color: white; border: none; padding: 8px 16px; font-size: 1.1em; border-radius: 4px; cursor: pointer; transition: background-color 0.3s;">重置</button>
                            </div>
                        ...
                        <div id="vector-database" style="display: none;">
                          ...
                          <p style="font-size: 1.1em; line-height: 1.5; color: #555;">
                            它定义了文档与聊天内容相关联所设定的最大距离。数值越高，来源范围越广。</p>
                          </br>
                          <hr style="margin: 30px 0; border: 1px solid #eee;" />
                          <div style="margin-top: 20px; display: flex; align-items: center;">
                            <label for="vector-distance"
                              style="font-size: 1.1em; margin-right: 10px; width: 200px;">相似度阈值(范围：0-1)：</label>
                          ...
                          <hr style="margin: 30px 0; border: 1px solid #eee;" />
                          <div style="margin-top: 20px; display: flex; align-items: center;">
                            <label for="vector-max-top"
                              style="font-size: 1.1em; margin-right: 10px; width: 100px;">最大条数</label>
                          ...
                          <div>
                            ...
                            <input type="text" id="searchText" placeholder="请输入查询内容..."
                              style="width: 80%; max-width: 800px; padding: 12px; font-size: 16px; border-radius: 8px; border: 1px solid #ccc;">
                            <button onclick="search()"
                              style="padding: 12px 24px; font-size: 16px; border: none; background-color: #007bff; color: white; border-radius: 8px; cursor: pointer;">搜索</button>
                          </div>
