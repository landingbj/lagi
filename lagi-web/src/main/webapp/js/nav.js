...
let promptNavs = [
    {
        ...
        subNavs: [
         ...
         已经收到您上传的图片。如果您想增强图片，请输入"图像增强"。如果您想使用AI描述图片，请输入"看图说话"。
        ...
        //     }
            {
                ...
                exampleVedioSrc: '../video/spsc.mp4',
                status: 1,
                prompt: '该功能可对根据用户输入的提示词，自动生成与之相关的视频。这有助于提高视频的创新性和生产效率，为影视制作、游戏开发、广告创意等领域提供更多的可能性。',
                operation: `如果您想生成视频，请输入"生成一只白色的萨摩耶在草地上玩耍的视频"。Lagi将会对您的请求作出响应。`
            }
        ]
    },
    {
