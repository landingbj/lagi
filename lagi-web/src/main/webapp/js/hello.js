...
function setDivSize() {
    ...
    const ball_container = document.querySelector('.ball-corner-container');
    if (ball_container) {
        const computedStyle = window.getComputedStyle(ball_container, '::before');
        ball_d = parseFloat(computedStyle.getPropertyValue('width'));;
    }
