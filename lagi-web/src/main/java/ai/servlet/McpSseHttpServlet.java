...
public class McpSseHttpServlet extends HttpServlet implements McpServerTransportProvider {

    /** Logger for this class */
    private static final Logger logger = LoggerFactory.getLogger(ai.mcps.server.transport.HttpServletSseServerTransportProvider.class);
    ...
    public McpSseHttpServlet() {
        this.objectMapper = new ObjectMapper();
        this.messageEndpoint = "/message";
        this.sseEndpoint = DEFAULT_SSE_ENDPOINT;
    }

    @Override
    public void init() throws ServletException {
        super.init();
        logger.info("Initializing HttpServletSseServerTransportProvider");
        ...
        McpServerFeatures.SyncResourceSpecification specificaiton = new McpServerFeatures.SyncResourceSpecification(
            ...
            McpSchema.ResourceContents resourceContents = new McpSchema.TextResourceContents(
                    resource.getUri(), resource.getMimeType(), "Hello, World!"
            );
        ...
        logger.info("finish Initializing HttpServletSseServerTransportProvider");
//        mcpServer.addResource(specificaiton);
//        mcpServer.addTool(tool1);
    }
     ...
     */
    public McpSseHttpServlet(ObjectMapper objectMapper, String messageEndpoint,
                             String sseEndpoint) {
