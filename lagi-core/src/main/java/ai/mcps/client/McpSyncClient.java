...
package ai.mcps.client;

import ai.mcps.spec.McpClientTransport;
import ai.mcps.spec.McpSchema;
import ai.mcps.spec.McpSchema.ClientCapabilities;
import ai.mcps.spec.McpSchema.GetPromptRequest;
import ai.mcps.spec.McpSchema.GetPromptResult;
import ai.mcps.spec.McpSchema.ListPromptsResult;
