...
public class AlibabaOSSUtil {
    ...
    private static final Logger log = LoggerFactory.getLogger(AlibabaOSSUtil.class);

    private static final String endpoint = "https://oss-cn-shanghai.aliyuncs.com";

    private static OSS buildCredentialsProvider(String accessKeyId , String  secretAccessKey) {
    ...
    public static boolean upload(String accessKeyId , String  secretAccessKey, String bucketName, String objectName , File file) {
    ...
    public static String getObjUrl(String accessKeyId , String  secretAccessKey, String bucketName, String objectName) {
        OSS ossClient = buildCredentialsProvider(accessKeyId, secretAccessKey);
        try {
            // 创建PutObjectRequest对象。
    ...
    public static String uploadAndGetUrl(String accessKeyId , String  secretAccessKey, String bucketName, String objectName , File file) {
