...
//        api_key: sk-QZNuNkCUQeukGSzX60oYHR9J1qQnOtLIwgI6BozM2sXvwpK1  #  url address https://platform.moonshot.cn/console/api-keys
//        api_key: sk-QZNuNkCUQeukGSzX60oYHR9J1qQnOtLIwgI6BozM2sXvwpKX  #  url address https://platform.moonshot.cn/console/api-keys
//        api_key: sk-ltjzc1nbaElYyykaMyOfCAPtZf91pd0QCXzCutVGviWRY4vA  #  url address https://platform.moonshot.cn/console/api-keys
//        String apiKey = "sk-QZNuNkCUQeukGSzX60oYHR9J1qQnOtLIwgI6BozM2sXvwpK";
        String apiKey = "sk-QZNuNkCUQeukGSzX60oYHR9J1qQnOtLIwgI6BozM2sXvwpKX";
        ...
        String reqStr = "{\n" +
                ...
                "    \"stream\": true\n" +
                "}";
        ChatCompletionRequest req = JSONUtil.toBean(reqStr, ChatCompletionRequest.class);
        LlmApiResponse completions;
        if(req.getStream()) {
            completions = streamCompletions(apiKey, apiUrl, 120, req, MoonshotConvert::convertStreamLine2ChatCompletionResult,  MoonshotConvert::convertByResponse);
        } else {
            completions = completions(apiKey, apiUrl, 120, req, MoonshotConvert::convertChatCompletionResult,  MoonshotConvert::convertByResponse);
        }

        if(completions.getCode() != 200){
            System.out.println(completions.getMsg());
            return ;
        }
        if(!req.getStream()) {
            System.out.println(completions.getData().getChoices().get(0).getMessage().getContent());
        } else {
            completions.getStreamData().subscribe(
                    data -> {
                        if(data !=null) {
